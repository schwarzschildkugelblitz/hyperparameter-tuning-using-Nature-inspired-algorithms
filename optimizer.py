...
def selector(algo, func_details, popSize, Iter):
    ...
    if algo == "SSA":
        ...
        x = pso.PSO(getattr(ML_Models, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "GA":
        ...
        x = gwo.GWO(getattr(ML_Models, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "BBO":
        x = bbo.BBO(getattr(ML_Models, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "WOA":
        x = woa.WOA(getattr(ML_Models, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "MVO":
        ...
        x = hho.HHO(getattr(ML_Models, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "HHOMP":
        ...
        x = de.DE(getattr(ML_Models, function_name), lb, ub, dim, popSize, Iter)
    elif algo == "HHO_copy":
